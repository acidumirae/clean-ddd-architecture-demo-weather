...
- [x] 2. Implement Application layer query and handler
    - [x] 2.1 Create GetHistoricalWeatherQuery and GetHistoricalWeatherQueryHandler
    ...
    - [x] 2.2 Write unit tests for GetHistoricalWeatherQueryHandler
...
- [x] 3. Extend Infrastructure layer with historical API call
    - [x] 3.1 Implement GetHistoricalWeatherAsync in WeatherApiService
    ...
    - [x] 3.2 Write unit tests for WeatherApiService historical method
...
- [x] 5. Implement Web layer controller and view
    - [x] 5.1 Create HistoricalWeatherController
    ...
    - [x] 5.2 Create Views/HistoricalWeather/Index.cshtml
    ...
    - [x] 5.3 Add Historical Weather nav link to _Layout.cshtml
    ...
    - [x] 5.4 Write unit tests for HistoricalWeatherController
...
- [x] 6. Property-based tests
    - [x] 6.1 Write property test for Property 1 — location is preserved
    ...
    - [x] 6.2 Write property test for Property 2 — days fall within requested date range
    ...
    - [x] 6.3 Write property test for Property 3 — view renders all forecast days
